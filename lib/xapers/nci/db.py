...
class DBManager(object):
    ...
    def get_document(self, docid):
        """returns :class:`Document` with given docid (str)"""
        query = self.query('id:' + docid)
        try:
            return Document(self, query.search_documents().next())
        except:
            return None
    ...
    def get_documents(self, querystring):
        """
        asynchronously look up documents matching `querystring`.
